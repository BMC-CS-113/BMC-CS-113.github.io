...
due_date: 2024-11-18 23:59:00EDT
...
We have provided an example `csv` file [courses.csv]({{ site.url }}{{ site.baseurl }}/hws/hw09/courses.csv) that you can use to test your program.
