...
due_date: 2023-02-29 23:59:00EDT
...
In this assignment you will be working with methods, `Strings`, and `Arrays`. You will be implementing the following methods recursively. For some of these methods, it might be easier to create another method that is called recursively. For example, recall how in lecture 9 we created a recursive method called [`public static int sumArray(String[] list, int index)`](https://github.com/BMC-CS-113/class-examples-s23/blob/main/week5/SumInputRecursion.java ) to sum all of the values in an array. 
