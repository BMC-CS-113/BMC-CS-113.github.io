...
* If no filename is passed in as a command line argument, the program should print a message to the user saying so and then terminate
* If a filename is passed in as a command line argument and the file does not exist, the program should print a message to the user saying so and then terminate.
...
We have provided method stubs in [Board.java]({{ site.url }}{{ site.baseurl }}/hws/hw07/Board.java) for you to complete.
